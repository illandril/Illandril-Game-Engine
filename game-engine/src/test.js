...
test.init = function(gameContainerID, doDebug) {
    ...
    for ( var i = 10; i <= worldSize.x - 10; i += 8 ) {
        ...
        b1.body.display.spriteSheet.url = 'graphics/spinner.png';
        var b2 = game.world.createBox( 10, 1, i, y );
        b2.body.SetAngle(game.world.getBox2DBodyDefinition().angle + Math.PI / 2);
        b2.body.display.spriteSheet.url = 'graphics/spinner.png';
    ...
    player = game.platformer.createPlayer(new Box2D.Common.Math.b2Vec2(5, worldSize.y - 5), new Box2D.Common.Math.b2Vec2(1.0, 1.0));
